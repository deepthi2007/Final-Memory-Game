...
function setup() {
    ...
    ground = createSprite(width/2,50,0,0);
    ground.addImage("IMG",groundImg);
    ground.scale =2;

    yellow1 = createSprite(400,60, 50, 100);
    yellow1.shapeColor="orange";
    yellow1.visible=false;
    blue1 = createSprite(width-310,60,50,100);
    blue1.shapeColor="orange";
    blue1.visible=false;
  
    blue2 = createSprite(400,height-310,50,100);
    blue2.shapeColor="orange";
    blue2.visible=false;
    green1 = createSprite(width-310,height-310,50,100);
    green1.shapeColor="orange";
    green1.visible=false;
  
    yellow2 = createSprite(width-310,height-80,50,100);
    yellow2.shapeColor="orange";
    yellow2.visible=false;
    green2 = createSprite(400,height-80,50,100);
    green2.shapeColor="orange";
    green2.visible=false;

    group = new Group();

    WonObj=createSprite(width/2,height/2,50,50);
